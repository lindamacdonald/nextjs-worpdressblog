            ...
            <div className="container mx-auto relative">
                ...
                <div id="mobile-menu" className={`${showMenu ? "flex" : "hidden"} dark:bg-gray-900 md:hidden absolute inset-0 z-10 flex-col w-full h-screen bg-white py-4`}>
                    ...
                    <div className="mt-4 mx-4">
                        ...
                        <Link href="/new" className="border-b border-gray-200 dark:border-gray-700 pb-4 px-1 flex items-center justify-between">
                               <div>
                            ...
                            <Link href="/newbie" className="border-b border-gray-200 dark:border-gray-700 pb-4 px-1 flex items-center justify-between">
                               <div> <a className="focus:outline-none dark:text-white focus:ring-2 focus:ring-gray-800 text-base text-gray-800 hover:underline">
                                    {" "}
                                    Men{" "}
                                </a>
                                <button aria-label="Add" className="dark:text-white dark:hover:text-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-800 rounded hover:bg-gray-100">
                            ...
                            <Link href="/modern" className="border-b border-gray-200 dark:border-gray-700 pb-4 px-1 flex items-center justify-between">
                                <div><a className="focus:outline-none dark:text-white focus:ring-2 focus:ring-gray-800 text-base text-gray-800 hover:underline">
                                    {" "}
                                    Women{" "}
                                </a>
                            ...
                            <Link href="linda" className="border-b border-gray-200 dark:border-gray-700 pb-4 px-1 flex items-center justify-between">
                                <div><a className="dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-800 text-base text-gray-800 hover:underline">
                                    {" "}
                                    Kids{" "}
                                </a>
                                <button aria-label="Add" className="dark:text-white dark:hover:text-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-800 rounded hover:bg-gray-100">
                            ...
                            <Link href="/macdonald" className="border-b border-gray-200 dark:border-gray-700 pb-4 px-1 flex items-center justify-between">
                               <div><a href="javascript:void(0)" className="focus:outline-none dark:text-white focus:ring-2 focus:ring-gray-800 text-base text-gray-800 hover:underline">
                                    {" "}
                                    Magazine{" "}
                                </a>
                                <button aria-label="Add" className="dark:text-white dark:hover:text-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-800 rounded hover:bg-gray-100">
